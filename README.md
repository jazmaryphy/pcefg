...
with $\mathbf{x}_k \equiv ({x_{1k}}, {x_{2k}}, {x_{2k}})$
...
where $\delta_{ij}$ is the Kronecker delta and $r_k = \lvert \mathbf{x}_k \rvert$ with $\mathbf{x}_k \equiv ({x_{1k}}, {x_{2k}}, {x_{2k}})$.
